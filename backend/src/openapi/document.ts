  ...
  components: {
    ...
    schemas: {
      ...
      DashboardMetrics: {
        ...
        properties: {
          calves: { type: 'integer' },
          weaners: { type: 'integer' },
          heifers: { type: 'integer' },
          cows: { type: 'integer', description: 'Mature cows only (not heifers)' },
          bulls: { type: 'integer' },
          steers: { type: 'integer' },
          totalActive: { type: 'integer' },
          totalMilkToday: { type: 'number' },
          healthAlerts: { type: 'integer', description: 'Overdue follow-up events; the app list also includes lifecycle and withdrawal alerts' },
