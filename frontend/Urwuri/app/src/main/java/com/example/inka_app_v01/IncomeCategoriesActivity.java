...
public class IncomeCategoriesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerTitle.setText(getString(R.string.income_categories));
        ...
        // Sample data
        categoryList.add("Milk Sale");
        categoryList.add("Cattle Sale");
        categoryList.add("Other Income");
    ...
    private void showAddCategoryDialog() {
        ...
        dialogTitle.setText(getString(R.string.add_income_category));
        inputLabel.setText(getString(R.string.income_category_name));
        categoryInput.setHint(getString(R.string.enter_income_category_name));
